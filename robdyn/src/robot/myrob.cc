...
namespace robot
{
    ...
    void myrob :: _build(Environment_hexa& env, const Vector3d& pos)
    {
        ...
        static const double body_width = 0.64;
        static const double body_height =0.04;

        static const double legP1_w = 0.02;
        static const double legP1_length = 0.56;
        static const double legP1_dist = 0.2;
        static const double legP1_mass = 0.020;

            static const double legP2_w = 1.02;
        static const double legP2_length = 0.885;
